define(function(require,exports,module) {
	var splitscreen_creat = require('http://ivonxiao.github.io/screen/screen/js/create_splitscreen.cmd.js');
	var REQUEST_URL = {
		'edit_screen_by_id' : '',
	...
	function domInit() {
		...
		$table.on('click','.fa-pencil-square',function() {
			...
			$('#main_content').load(url,function() {
				splitscreen_creat.renderScreenById(screenId);
			});	
		});
	}
	exports.init = domInit;
});